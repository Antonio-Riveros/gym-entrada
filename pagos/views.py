...
class PagoCreateView(CreateView):
    ...
    def get_initial(self):
        ...
        if alumno_id:
            try:
                ...
                # Calcular monto sugerido (precio de las disciplinas activas)
                ...
                for inscripcion in inscripciones_activas:
                    monto_sugerido += inscripcion.disciplina.precio_mensual
    ...
    def form_valid(self, form):
        # Por defecto, cuando se crea un pago se marca como pagado
